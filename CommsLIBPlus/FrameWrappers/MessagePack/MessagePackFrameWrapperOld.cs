...
namespace CommsLIBPlus.Communications.FrameWrappers.MessagePack
{
    public class MessagePackFrameWrapperOld<T> : SyncFrameWrapper<T>
    {
        ...
        public MessagePackFrameWrapperOld() : base(false)
        {
